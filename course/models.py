...
class Course(models.Model):
    category_choices = [('marketing','marketing'),
    ('programming','Programming'),('web','Web Development'),('app','App Development'),
    ('game','Game Development'),('database','Database Management'),('network','Network Security'),
    ('cloud','Cloud Computing'),('iot','Internet of Things'),('blockchain','Blockchain Technology'),
    ('cyber','Cyber Security'),('vr','Virtual Reality'),('ar','Augmented Reality'),('mr','Mixed Reality'),
    ('robotics','Robotics'),('bigdata','Big Data'),('datascience','Data Science'),('ai','Artificial Intelligence'),
    ('ml','Machine Learning'),('dl','Deep Learning'),('cv','Computer Vision'),('nlp','Natural Language Processing')]
